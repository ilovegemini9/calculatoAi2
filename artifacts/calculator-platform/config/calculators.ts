...
export const CALCULATORS: CalculatorMeta[] = [
  ...
  { slug: 'average-rating', name: 'Average Rating Calculator', shortName: 'Average Rating', category: 'math', description: 'Calculate a weighted star-rating average from vote counts.', keywords: ['average rating calculator', 'star rating average'], icon: '★' },
  { slug: 'least-to-greatest', name: 'Least to Greatest Calculator', shortName: 'Least to Greatest', category: 'math', description: 'Sort displayed observations from least to greatest.', keywords: ['least to greatest calculator', 'sort numbers'], icon: '↗' },
  { slug: 'percentile-rank', name: 'Percentile Rank Calculator', shortName: 'Percentile Rank', category: 'math', description: 'Estimate the share of observations at or below a selected value.', keywords: ['percentile rank calculator', 'percentile score'], icon: '%' },
  { slug: 'pressure-unit-conversion', name: 'Pressure Unit Conversion', shortName: 'Pressure Unit Conversion', category: 'lifestyle', description: 'Convert a pressure value between bar, psi, atm, and pascals.', keywords: ['pressure unit conversion', 'bar psi converter'], icon: '⇄' },
  { slug: 'salary-to-hourly', name: 'Salary to Hourly Calculator', shortName: 'Salary to Hourly', category: 'financial', description: 'Convert annual salary into hourly, weekly, and monthly equivalents.', keywords: ['salary to hourly calculator', 'annual salary hourly'], icon: '$' },
  { slug: 'discount-rate', name: 'Discount Rate Calculator', shortName: 'Discount Rate', category: 'financial', description: 'Estimate a periodic discount rate from present and future values.', keywords: ['discount rate calculator', 'present future value rate'], icon: '%' },
  { slug: 'linear-combination', name: 'Linear Combination Calculator', shortName: 'Linear Combination', category: 'math', description: 'Solve two linear equations in two variables with elimination.', keywords: ['linear combination calculator', 'elimination method calculator'], icon: '∑' },
