...
export const CALCULATOR_CONTENT: Record<string, CalcContent> = {
  ...
  'scientific': {howToSteps:['Enter the labeled values.','Confirm units and signs.','Review the live result.','Use the result for educational or planning purposes.'],formula:{expression:'sin(x), cos(x), ln(x), and x² are evaluated on the entered number.',variables:[{symbol:'x',definition:'Input value'}],notes:'Natural log is shown as zero for non-positive input.'},examples:[{title:'Scientific functions',scenario:'Enter a value and review common functions.',steps:['Enter x.','Evaluate each function.','Check domain assumptions.','Review results.'],result:'Square, sine, cosine, and natural log are displayed.'}],useCases:['Quick scientific reference.'],commonPitfalls:['Confusing radians and degrees.','Using ln for non-positive values.'],glossary:[{term:'Radian',definition:'Angular unit used by JavaScript trigonometric functions.'}],faqs:[{question:'Are results client-side?',answer:'Yes.'},{question:'Does it replace a symbolic system?',answer:'No.'}],sources:[{title:'NIST Digital Library of Mathematical Functions',publisher:'NIST',url:'https://dlmf.nist.gov/',year:2026}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
