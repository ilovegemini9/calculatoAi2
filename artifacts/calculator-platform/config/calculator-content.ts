...
export const CALCULATOR_CONTENT: Record<string, CalcContent> = {
  ...
  'area': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'Circle area = πr²; surface area = 4πr².',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
  'distance': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'Distance = √((x₂−x₁)² + (y₂−y₁)²).',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
  'sample-size': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'n = z²p(1−p) ÷ e², rounded up.',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
  'probability': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'P(X=k) = C(n,k)p^k(1−p)^(n−k).',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
  'statistics': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'Mean, median, mode, and range summarize the entered observations.',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
  'permutation-and-combination': {howToSteps:['Enter the labeled values.','Confirm units and domain.','Review the result.','Use it for education or planning.'],formula:{expression:'P(n,r) = n! ÷ (n−r)!.',variables:[{symbol:'x',definition:'Entered numeric value'}],notes:'Invalid or non-finite inputs are guarded.'},examples:[{title:'Worked example',scenario:'Enter valid values.',steps:['Enter inputs.','Apply the formula.','Check the domain.','Review output.'],result:'The result updates client-side.'}],useCases:['Math education.','Quick numerical analysis.'],commonPitfalls:['Mixing units.','Using invalid domains.'],glossary:[{term:'Distribution',definition:'How values or outcomes are represented.'}],faqs:[{question:'Are calculations client-side?',answer:'Yes.'},{question:'Are results rounded?',answer:'Only for display.'}],sources:[{title:'NIST/SEMATECH e-Handbook',publisher:'NIST',url:'https://www.itl.nist.gov/div898/handbook/',year:2024}],author:{name:'CalculatorFree Math Review Team',credentials:'Calculation Review',description:'Original client-side model.'}},
