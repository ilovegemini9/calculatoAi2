...
export const REFERENCE_MENU_GROUPS: MenuGroup[] = [
  ...
  { id: 'utilities', label: 'Utilities', description: 'Dates, time, conversions, generators, encoding, and everyday reference tools.', slugIncludes: ['date', 'time', 'hours', 'age', 'conversion', 'random-number', 'password', 'dice-roller', 'shoe-size', 'day-counter', 'days-until', 'day-of-the-week', 'bandwidth', 'base64', 'url-encode', 'ip-subnet', 'height'] },
