...
2. FEATURED SNIPPET: The very first paragraph after the Key Takeaways box must be a 40–60 word direct, factual answer to the main query "${keyword}". Self-contained — someone reading only this paragraph gets the complete answer. This is what Google AI Overview, ChatGPT, Gemini, and Perplexity cite as featured snippets.

3. Use H2 headings for major sections. H3 for sub-points. 4-6 H2 sections total. Begin each H2 section with ONE crisp declarative sentence summarizing what the section covers — AI systems use these as section anchors.
...
6. FAQ section with 4-5 specific, real questions readers have:
   ...
   Each answer must be a COMPLETE STANDALONE SENTENCE starting with the topic — voice assistants read these aloud without surrounding context.
...
E-E-A-T: Include at least one real statistic from an authoritative source (government, academic, major institution). Use experiential language where natural: "In practice…", "What most people overlook…", "The real figure is…". Never fabricate statistics.

ENTITY SEO: Mention 2–3 relevant named entities (regulatory bodies, standards organizations, specific formulas, named concepts) naturally in context. Do not list them separately.

SEMANTIC SEO: Use the full vocabulary of the topic — related terms, synonyms, adjacent concepts. Think: what words appear throughout a comprehensive article on this subject beyond the focus keyword?

VOICE SEARCH: Every FAQ answer must function as a standalone spoken response. Start with the topic noun: "The [topic] is…" or "To [action], you…"

HELPFUL CONTENT: Solve the reader's problem completely. Include at least one non-obvious insight per major section — something not in the top 5 Google results on this topic.
